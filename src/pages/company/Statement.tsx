  ...
  return (
    <section className="flex flex-col">
      <div className=" w-full flex flex-col md:grid grid-cols-2">
        <div className="flex flex-col gap-5 w-full bg-[#CBEEF4]">
          <div className="w-full flex flex-col gap-5 px-5 md:px-20 py-7 md:py-20">
            ...
            <p className="text-lg md:text-2xl">
              To be the future of on-Demand Services in
        ...
        <div className="flex flex-col gap-5 w-full bg-[#F3EDF9]">
          <div className="w-full flex flex-col gap-5 px-5 md:px-20 py-7 md:py-20">
            <h3 className="text-3xl md:text-[48px] font-[600] leading-snug grad">
              Our Mission
            </h3>
            <p className="text-lg md:text-2xl">
              Elevating the quality of life by solving real world problems for{" "}
              <br className="hidden md:block" /> Africans.
            </p>
          </div>
          <figure className="w-full">
