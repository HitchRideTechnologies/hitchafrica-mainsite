...
Behind Hitch
      ...
      <div className="flex flex-col md:grid grid-cols-4 gap-10">
        ...
        <Single img={team2} name="Chris Olajide" pos="Co-founder" />
        <Single img={team3} name="Rachel Amadi" pos="Developer" />
        <Single img={team4} name="Dorcas Nwankwo" pos="Designer" />
      </div>
    </main>
  );
}
...
const Single = ({ img, name, pos }: Props): JSX.Element => {
    return (
      <div className="flex flex-col gap-4 relative w-full">
        <Image src={img} alt="" className="w-full h-full object-cover" unoptimized />
