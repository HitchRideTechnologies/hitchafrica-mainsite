  ...
  return (
    ...
    >
      ...
      <div className=" w-full flex flex-col md:grid grid-cols-2 gap-10">
        <div
          className="relative z-0 h-auto md:h-[90vh] flex flex-col justify-evenly gap-5 md:gap-10 py-10 md:py-20 px-5 md:pl-10 bg-[rgba(4,187,198,0.20)] relative otherbg bg-contain"
        ...
        <div
          className="relative z-0 h-auto md:h-[90vh] flex flex-col justify-evenly gap-5 md:gap-10 py-10 md:py-20 px-5 md:pl-10 bg-[rgba(153,113,195,0.10)] relative otherbg bg-contain"
        ...
        <div
          className="relative z-0 h-auto md:h-[90vh] flex flex-col justify-evenly gap-5 md:gap-10 py-10 md:py-20 px-5 md:pl-10 bg-[#E7F2D6] relative otherbg bg-contain"
        ...
        <div
          className="relative z-0 h-auto md:h-[90vh] flex flex-col justify-evenly gap-5 md:gap-10 py-10 md:py-20 px-5 md:pl-10 bg-[rgba(242,71,137,0.10)] relative otherbg bg-contain"
