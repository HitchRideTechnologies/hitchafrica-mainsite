...
export default function People() {
  return (
    <main className="px-5 md:px-20 py-10 md:py-20 flex flex-col gap-10 w-full">
      ...
      <div className="w-full grid grid-cols-[1fr_1.3fr] grid-rows-1 gap-10">
        ...
        <figure className="w-full grid grid-rows-2 gap-10">
          <Image
            src={pple2}
            alt=""
            className="w-full h-full object-cover rounded-xl"
      ...
      <div className="w-full grid grid-cols-[1.3fr_1fr] grid-rows-1 gap-10">
        <div className="w-full grid grid-rows-2 gap-10">
          <figure className="grid grid-cols-2 gap-10">
            <Image
              src={pple4}
              alt=""
              className="w-full h-full object-cover rounded-xl"
